...
import securityObjectivesApi from './securityObjectivesApi';
...
const securityAssessmentsApi = {
  ...
  promoteFindingToRisk: async (clientId, findingId, riskData) => {
    ...
    try {
      ...
      const findingResponse = await fetch(`${API_URL}/assessmentHistory/${findingId}`);
      ...
      await fetch(`${API_URL}/assessmentHistory/${findingId}`, {
        method: 'PATCH',
